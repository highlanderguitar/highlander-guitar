# Set-list canonical progression normalization

Canonical TG measure 1 is count-in. User tune measure 1 begins at TG measure 2. `/` means two successive chords, provisionally two beats each; all such labels say `SPLIT TIMING NEEDS REVIEW`.

| Tune | Exact supplied progression |
|---|---|
